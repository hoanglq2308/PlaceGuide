...
namespace PlaceGuide.Server.Migrations
{
    ...
    [Migration("20260627191911_DropLegacyLanguageColumns")]
    partial class DropLegacyLanguageColumns
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("PlaceGuide.Server.Models.AudioListeningEvent", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.HasIndex("CreatedAt", "AudioType");

                    b.HasIndex("CreatedAt", "LanguageCode");

                    b.ToTable("audio_listening_events", null, t =>
                        {
                            t.HasCheckConstraint("CK_audio_listening_events_AudioType", "\"AudioType\" IN ('restaurant', 'dish')");
                            ...
                            t.HasCheckConstraint("CK_audio_listening_events_LanguageCode", "\"LanguageCode\" IN ('vi', 'en', 'zh-CN', 'zh-TW', 'ko', 'ja', 'th', 'fr', 'ru')");
                        });
                });
            ...
            modelBuilder.Entity("PlaceGuide.Server.Models.PaymentOrder", b =>
                {
                    ...
                    b.ToTable("payment_orders", null, t =>
                        {
                            t.HasCheckConstraint("CK_payment_orders_Amount_Positive", "\"AmountVnd\" > 0");

                            t.HasCheckConstraint("CK_payment_orders_Currency", "\"Currency\" = 'VND'");

                            t.HasCheckConstraint("CK_payment_orders_Status", "\"Status\" IN ('pending', 'paid', 'expired', 'cancelled', 'failed')");
                        });
                });
            ...
            modelBuilder.Entity("PlaceGuide.Server.Models.Restaurant", b =>
                {
                    ...
                    b.ToTable("restaurants", null, t =>
                        {
                            t.HasCheckConstraint("CK_restaurants_Banned_Not_Open", "NOT (\"IsBanned\" = TRUE AND \"IsOpen\" = TRUE)");

                            t.HasCheckConstraint("CK_restaurants_Banned_Not_Published", "NOT (\"IsBanned\" = TRUE AND \"IsPublished\" = TRUE)");

                            t.HasCheckConstraint("CK_restaurants_Latitude_Range", "\"Latitude\" BETWEEN -90 AND 90");

                            t.HasCheckConstraint("CK_restaurants_Longitude_Range", "\"Longitude\" BETWEEN -180 AND 180");

                            t.HasCheckConstraint("CK_restaurants_Rating_Range", "\"Rating\" BETWEEN 0 AND 5");
                        });
                });
            ...
            modelBuilder.Entity("PlaceGuide.Server.Models.RestaurantRegistration", b =>
                {
                    ...
                    b.ToTable("restaurant_registrations", null, t =>
                        {
                            t.HasCheckConstraint("CK_restaurant_registrations_Status", "\"Status\" IN ('Pending', 'Approved', 'Rejected')");
                        });
                });
            ...
            modelBuilder.Entity("PlaceGuide.Server.Models.Review", b =>
                {
                    ...
                    b.HasIndex("RestaurantId", "GuestReviewKeyHash")
                        .IsUnique()
            ...
            modelBuilder.Entity("PlaceGuide.Server.Models.ReviewMedia", b =>
                {
                    ...
                    b.ToTable("review_media", null, t =>
                        {
                            t.HasCheckConstraint("CK_review_media_FileSize_Max25MB", "\"FileSize\" <= 26214400");

                            t.HasCheckConstraint("CK_review_media_FileSize_Positive", "\"FileSize\" > 0");

                            t.HasCheckConstraint("CK_review_media_MediaType", "\"MediaType\" IN ('image', 'video')");
                        });
                });
            ...
            modelBuilder.Entity("PlaceGuide.Server.Models.VisitorDistrictActivity", b =>
                {
                    ...
                    b.ToTable("visitor_district_activities", null, t =>
                        {
                            t.HasCheckConstraint("CK_visitor_district_activities_EventCount", "\"EventCount\" >= 1");

                            t.HasCheckConstraint("CK_visitor_district_activities_SourceType", "\"SourceType\" IN ('RestaurantView', 'GeoLocation')");
                        });
                });
            ...
            modelBuilder.Entity("PlaceGuide.Server.Models.VisitorHourlyActivity", b =>
                {
                    ...
                    b.ToTable("visitor_hourly_activities", null, t =>
                        {
                            t.HasCheckConstraint("CK_visitor_hourly_activities_EventCount", "\"EventCount\" >= 1");
                        });
                });
